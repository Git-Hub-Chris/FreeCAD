...
public:
    ...
    fastsignals::signal<void(const std::vector<App::DocumentObject*>&, Base::Writer&)> signalExportObjects;
    fastsignals::signal<void(const std::vector<App::DocumentObject*>&, Base::Writer&)> signalExportViewObjects;
    fastsignals::signal<void(const std::vector<App::DocumentObject*>&, Base::XMLReader&)> signalImportObjects;
